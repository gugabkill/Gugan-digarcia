  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          backgroundImage:
            "url('./luxury-car-detail-with-legal-scales-symbol-overlay.png')",
      ...
      <div className="container mx-auto px-4 py-12 md:py-20 relative z-10">
        <div className="grid lg:grid-cols-2 gap-8 md:gap-16 items-center">
          ...
          >
            ...
            >
              Atuação técnica e estratégica em processos administrativos e
              judiciais envolvendo infrações de trânsito, suspensão de CNH,
              busca e apreensão, contratos de financiamento e revisões
              contratuais. Mais de 5 anos de experiência com{" "}
